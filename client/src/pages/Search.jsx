...
export default function Search() {
    ...
    useEffect(() => {
        ...
        const searchTechFromUrl = urlParams.get('searchTerm');
        ...
        // If the search value is changing , we will change the state
        if(
            searchTechFromUrl ||
            typeFromUrl ||
            parkingFromUrl ||
  ...
  return (
    <div className='flex flex-col md:flex-row'>
        ...
        <div className='p-7 border-b-2  md:w-1/2 md:border-r-2 md:min-h-screen '>
            <form onSubmit={handleSubmit} className='flex flex-col gap-8 '>
                {/* Search term and search bar */}
                <div className='flex items-center gap-2'> 
                    <label className='whitespace-nowrap font-semibold'>Search Term</label>
                    <input type='text' id = 'searchTerm' value={sidebardata.searchTerm} onChange={handleChange} placeholder='Search...' className='border rounded-lg p-3 w-full' ></input>
                </div>
        ...
        {/* Right side div for the listing result */}
